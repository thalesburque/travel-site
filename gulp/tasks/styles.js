...
hexrgba = require('postcss-hexrgba'); //convert hexdecimal value into a rgba value

gulp.task('styles', function() {
  return gulp.src('./app/assets/styles/styles.css') //import from this css file
    .pipe(postcss([cssImport, mixins, cssvars, nested, hexrgba, autoprefixer])) //allows these variables to run
